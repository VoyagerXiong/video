...
@section('content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <br>
            <form action="/admin/lesson/{{$lessondata['id']}}" method="post" class="form-horizontal" role="form">
                {{ method_field('PUT') }}
                @if (count($errors) > 0)
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="col-sm-10">
                                @foreach($tagData as $tag)
                                    <input type="checkbox" name="tag[]" value="{{$tag['id']}}"
                                           @if(in_array($tag['id'],$tagid)) checked @endif>{{$tag['name']}}
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="introduce" id="inputID" class="form-control"
                                       value="{{$lessondata['introduce']}}" title="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input class="form-control" name="preview" readonly=""
                                           value="{{$lessondata['preview']}}">
                                ...
                                <div class="input-group" style="margin-top:5px;">
                                    <img src="{{asset($lessondata['preview'])}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="checkbox" name="iscommend" value="1"
                                       @if($lessondata['iscommend']==1) checked @endif>推荐
                                <input type="checkbox" name="ishot" value="1"
                                       @if($lessondata['ishot']==1) checked @endif>热门
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" name="click" id="inputID" class="form-control"
                                   value="{{$lessondata['click']}}" title="">
                        </div>
                    </div>
                </div>
