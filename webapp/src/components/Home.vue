<template>
    <div>
        ...
        <div id="recommend">
            <router-link :to="'/page/'+v.id+'.html'" v-for="v in commendLessons" :key="v.id">
                <img :src="'http://video.vohome.xin/'+v.preview" alt=""/>
        ...
        <router-link to="/video/0.html" class="more">MORE</router-link>
        ...
        <div class="today">
            <div class="pic">
                <router-link :to="'/page/'+v.id+'.html'" v-for="v in hotLessons" :key="v.id"><img :src="'http://video.vohome.xin/'+v.preview"/></router-link>
            </div>
        </div>
        <br>
        <br>
...
//              direction : 'vertical',
        ...
        mounted() {
            this.axios.get('http://video.vohome.xin/api/CommendLessons/4').then((response) => {
//                console.log(response.data)
            ...
            this.axios.get('http://video.vohome.xin/api/HotLessons/3').then((response) => {
//                console.log(response.data)
                if (response.data.code == 200) {
